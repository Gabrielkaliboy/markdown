...
var provinceList = [  
//这里是为了初始化的时候，选择所在地那里为空，目的是校验用户是否选择了，如果想初始化的时候里面有内容，就把第一个去掉
...
{name:'台湾', cityList:[  
    ...
    { name: '高雄市', areaList: [" 新兴区", "前金区", "芩雅区", "盐埕区", "鼓山区", "旗津区", "前镇区", "三民区", "左营区", "楠梓区", "小港区"] },
    { name: '基隆市', areaList: [" 仁爱区", "信义区", "中正区", "中山区", "安乐区", "暖暖区", "七堵区"] },
    { name: '台中市', areaList: ["中区", "东区", "南区", "西区", "北区", "北屯区", "西屯区", "南屯区"] },
    { name: '台南市', areaList: ["中西区", "东区", "南区", "北区", "安平区", "安南区"] },
    { name: '新竹市', areaList: ["东区", "北区", "香山区"] },
    { name: '嘉义市', areaList: ["东区", "西区"] },
]},  
{name:'香港', cityList:[  
    { name: '市辖区', areaList: ["中西区", "东区", "九龙城区", "观塘区", "南区", "深水埗区", "湾仔区", "黄大仙区", "油尖旺区", "离岛区", "葵青区", "北区", "西贡区", "沙田区", "屯门区", "大埔区", "荃湾区", "元朗区"] },
]},  
{name:'澳门', cityList:[  
    { name: '澳门半岛', areaList: ["花地玛堂区", " 圣安多尼堂区", " 望德堂区", "大堂区", "风顺堂区"] },
    { name: '凼 仔 岛', areaList: ["凼 仔 岛"] },
    { name: '路 环 岛', areaList: ["路 环 岛"] }
]}  
];  